...
func registerGeneratedRouteOrdersControllerGet_6c501b92(
	ctx context.Context,
	...
	authorizationPolicy0, authorizationPolicy0Err := spicesecurity.NewPolicy(spicesecurity.PolicySpec{
		Definition: spicesecurity.Definition{
			ID:     "spice:symbol:v1|method|42:github.com/spice-framework/commerce/orders|10:Controller|3:Get",
	...
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|42:github.com/spice-framework/commerce/orders|10:Controller|3:Get", Module: "github.com/spice-framework/commerce/orders", Method: "GET", Pattern: "/orders/{id}"}, httpObservers...)
