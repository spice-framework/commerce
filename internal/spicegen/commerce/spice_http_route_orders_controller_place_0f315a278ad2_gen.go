...
func registerGeneratedRouteOrdersControllerPlace_0f315a27(
	ctx context.Context,
	...
	authorizationPolicy0, authorizationPolicy0Err := spicesecurity.NewPolicy(spicesecurity.PolicySpec{
		Definition: spicesecurity.Definition{
			ID:     "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/commerce/orders|10:Controller|5:Place",
