...
func registerGeneratedRouteOrdersControllerSendReceipt_749cb64d(
	ctx context.Context,
	...
	authorizationPolicy0, authorizationPolicy0Err := spicesecurity.NewPolicy(spicesecurity.PolicySpec{
		Definition: spicesecurity.Definition{
			ID:     "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/commerce/orders|10:Controller|11:SendReceipt",
	...
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|57:github.com/spice-framework/spice/examples/commerce/orders|10:Controller|11:SendReceipt", Module: "github.com/spice-framework/spice/examples/commerce/orders", Method: "POST", Pattern: "/orders/{id}/receipt"}, httpObservers...)
