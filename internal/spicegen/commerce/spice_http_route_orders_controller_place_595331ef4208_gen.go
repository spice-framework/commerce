...
func registerGeneratedRouteOrdersControllerPlace_595331ef(
	ctx context.Context,
	...
	authorizationPolicy0, authorizationPolicy0Err := spicesecurity.NewPolicy(spicesecurity.PolicySpec{
		Definition: spicesecurity.Definition{
			ID:     "spice:symbol:v1|method|42:github.com/spice-framework/commerce/orders|10:Controller|5:Place",
	...
	routeObservation0, routeObservationErr0 := spiceweb.ObservationMiddleware(spiceweb.RouteMetadata{ID: "spice:symbol:v1|method|42:github.com/spice-framework/commerce/orders|10:Controller|5:Place", Module: "github.com/spice-framework/commerce/orders", Method: "POST", Pattern: "/orders"}, httpObservers...)
