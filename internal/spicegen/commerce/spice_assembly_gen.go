...
func NewApplicationWithOptions(ctx context.Context, options ApplicationOptions) (*Application, error) {
	...
	application.components = Components{
		ViewAudit:             dependencies.viewAudit,
		OrderEvents:           dependencies.orderEvents,
		Mux:                   dependencies.mux,
		OrdersSettings:        dependencies.ordersSettings,
		OrderRepository:       dependencies.orderRepository,
		StorageSettings:       dependencies.storageSettings,
		OpenDatabase:          dependencies.openDatabase,
		Native:                dependencies.native,
		ReadExecutor:          dependencies.readExecutor,
		Transactions:          dependencies.transactions,
		OfflineProcessor:      dependencies.offlineProcessor,
		PaymentsSettings:      dependencies.paymentsSettings,
		StripeProcessor:       dependencies.stripeProcessor,
		PlatformSettings:      dependencies.platformSettings,
		Server:                dependencies.server,
		InventorySettings:     dependencies.inventorySettings,
		...
		NotificationsSettings: dependencies.notificationsSettings,
